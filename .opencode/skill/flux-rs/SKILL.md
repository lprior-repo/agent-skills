...
{"kind":"scope","does_not_own":["reactive UI Flux architecture","signals/effects/component lifecycle/forms as framework concepts","Verus proof bodies","Kani concrete execution harnesses","runtime memory leak profiling","inventing Flux output or tool availability"]}
