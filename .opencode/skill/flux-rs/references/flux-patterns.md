...
Refined enums are good for parser outcomes, validated/unvalidated modes, and small protocol-like state machines.
...
If the correctness property is about ordering, retries, cancellation, fairness, leases, or eventuality, model it with an interleaving tool rather than Flux alone.
