...
{"kind":"rule","id":"scope_first","text":"Prefer focused Glob/Grep/Read over broad repository scans. Start from bead text, changed files, module names, or user-provided paths, then widen only when evidence demands it."}
