...
|---|---|---|
| Temporal workflow, queue ordering, retry, lease, lifecycle, cancellation, distributed protocol | TLA+ | Behavior depends on state over time or interleavings across actors |
...
| Unsafe, FFI, raw pointers, aliasing, provenance, interior-mutability UB risk | Miri | Runtime UB or provenance risk is in scope |
