...
Report each trusted or ignored item that affects the property being claimed. Existing unrelated trusted code can be recorded as global debt, but touched or scoped trusted code is local evidence debt.
